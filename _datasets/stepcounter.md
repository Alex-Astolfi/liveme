---
schema: liveme
title: 2024-Shb-Trento-Step Counter Event
organization: liveme organization  # Copyright Holders in the config file
notes: Android API that generates an event when a step is detected. The step counter sensor is used to get the total number of steps taken by the user since the last reboot (power on) of the phone.
resources:
    - name: codebook
      # URL must link to the corresponding codebook
      url: >-
          /liveme/documentation/codebooks/stepcounter.html
      format: html
...
publication_date: 2024-11-03 14:06:31  # Current timestamp
identifier: 007.AAAO.AAA.BH  # Generated based on the defined rules
